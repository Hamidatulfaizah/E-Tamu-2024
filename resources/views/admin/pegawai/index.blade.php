...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">List Data Pegawai</li>
    </ol>
</div>
    ...
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div class="btn-group m-b-10">
                ...
                <a href="{{ route('cetak.pegawai') }}" class="btn btn-danger btn-sm"><i class="fa fa-solid fa-download"></i> Download PDF</a>
                <a href="{{ route('export.exel') }}" class="btn btn-success btn-sm"><i class="fa fa-solid fa-download"></i> Download Excel</a>
                {{-- <button class="btn btn-info btn-sm"><i class="fa fa-solid fa-download"></i> Download Excel</button> --}}
            </div>
