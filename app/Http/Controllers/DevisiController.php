...
class DevisiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'email_devisi' => 'required|email',//validasi email
        ]);
        ...
        $data->email_devisi = $request->email_devisi;
        $data->save();
    ...
    public function edit(Request $request)
    {
		...
		return response()->json([
            'id'=> $emp->id,
            'nama_devisi'=>$emp->nama_devisi,
            'email_devisi'=>$emp->email_devisi,
        ]);
    }
    ...
    public function update(Request $request)
    {
		...
		$empData = [
            ...
            'email_devisi' => $request->email_devisi,
        ];
		$emp->update($empData);
		return response()->json([
			'status' => 200,
